...
<section id="group-{date}" class="relative">
 ...
 <div class="sticky top-16 z-10 py-4 bg-base-200/80 backdrop-blur-md -mx-4 px-4 flex items-center justify-between">
  <h3 class="text-xs font-black tracking-wide text-base-content/40 flex items-center gap-3">
   {formatHeaderDate(date)}
  </h3>
  <div class="badge badge-ghost badge-xs opacity-60 tracking-tighter uppercase border-none">
